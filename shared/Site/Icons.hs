...
-----------------------------------------------------------------------------
svg :: [View context props model action] -> View context props model action
...
-----------------------------------------------------------------------------
iconStar :: View context props model action
iconStar = filled []
  [ S.path_ [ SP.d_ "m12 17.27 4.15 2.51c.76.46 1.69-.22 1.49-1.08l-1.1-4.72 3.67-3.18c.67-.58.31-1.68-.57-1.75l-4.83-.41-1.89-4.46c-.34-.81-1.5-.81-1.84 0L9.19 8.63l-4.83.41c-.88.07-1.24 1.17-.57 1.75l3.67 3.18-1.1 4.72c-.2.86.73 1.54 1.49 1.08z" ] ]
-----------------------------------------------------------------------------
iconDiscord :: View context props model action
iconDiscord = filled []
...
-----------------------------------------------------------------------------
iconX :: View context props model action
iconX = filled []
...
-----------------------------------------------------------------------------
-- | The X "verified" badge: a scalloped disc with a check cut out of it.
iconVerified :: View context props model action
iconVerified = S.svg_ [ SP.viewBox_ "0 0 24 24", P.class_ "icon tweet-verified", P.aria_ "hidden" "true", SP.fill_ "currentColor" ]
  [ S.path_ [ SP.d_ "M22.25 12c0-1.43-.88-2.67-2.19-3.34.46-1.39.2-2.9-.81-3.91s-2.52-1.27-3.91-.81c-.66-1.31-1.91-2.19-3.34-2.19s-2.67.88-3.33 2.19c-1.4-.46-2.91-.2-3.92.81s-1.26 2.52-.8 3.91c-1.31.67-2.2 1.91-2.2 3.34s.89 2.67 2.2 3.34c-.46 1.39-.21 2.9.8 3.91s2.52 1.26 3.91.81c.67 1.31 1.91 2.19 3.34 2.19s2.68-.88 3.34-2.19c1.39.45 2.9.2 3.91-.81s1.27-2.52.81-3.91c1.31-.67 2.19-1.91 2.19-3.34zm-11.71 4.2L6.8 12.46l1.41-1.42 2.26 2.26 4.8-5.23 1.47 1.36-6.2 6.77z" ] ]
-----------------------------------------------------------------------------
iconSun :: View context props model action
iconSun = svg
...
-----------------------------------------------------------------------------
copyIcon :: View context props model action
copyIcon = svg
...
-----------------------------------------------------------------------------
checkIcon :: View context props model action
checkIcon = svg [ path "M4.5 12.5l5 5 10-11" ]
-----------------------------------------------------------------------------
iconExternal :: View context props model action
